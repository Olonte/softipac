							...
							<form:form id="citaInformacion" name="citaInformacion" modelAttribute="citaInformacion" method="post">
								...
								<div id="accordion" role="tablist" aria-multiselectable="true">
									...
									<div class="card">
										...
										<!-- *******************************************************Datos Familiar**************************************************************************************** -->
										<div class="card">
											<div class="card-header" role="tab" id="headingDatosFamiliar">
												<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseDatosFamiliar" aria-expanded="false" aria-controls="collapseDatosFamiliar">
													<h5 class="mb-0">${acudienteEtiqueta}</h5>
												</a>
											</div><!-- .card-header -->
											<div id="collapseDatosFamiliar" class="collapse show" role="tabpanel" aria-labelledby="headingDatosFamiliar">
												<div class="card-block">
		                                    		<div class="card-body">
		                                    			<div class="row">
		                                    	    		<!-- **************************************************Id Tipo Estado Familiar**************************************************************** -->
		                                    				<form:input type="hidden" cssClass="form-control" path="familiar.idUsuario" id="familiarIdUsuario" name="familiarIdUsuario"></form:input>
		                                    				<form:input type="hidden" cssClass="form-control" path="familiar.tipousuario_idtipousuario.idTipoUsuario" id="familiarIdTipoUsuario" name="familiarIdTipoUsuario"></form:input>
		                                    				<form:input type="hidden" cssClass="form-control" path="familiar.estado_idestado.idEstado" id="familiarIdEstado" name="familiarIdEstado"></form:input>
															<!-- **************************************************Datos Parentesco Familiar**************************************************************** -->
			                                    			<div class="col-md-4">
			                                    				<div class="form-group">
									 								<form:label path="familiar.parentesco_idparentesco.idParentesco">${parentescoEtiqueta}</form:label>
																	<div class="input-group">									 
																		<form:select path="familiar.parentesco_idparentesco.idParentesco" id="familiarIdParentesco" cssClass="form-control">
																			<form:option value="${seleccion}" label="${seleccionEtiqueta}"></form:option>
																			<form:options items="${parentescos}" itemValue="idParentesco" itemLabel="parentesco"></form:options>
																		</form:select>
																	</div><!-- .input-group -->
																	<div class="has-error">
																		<form:errors path="familiar.parentesco_idparentesco.idParentesco" cssClass="text-danger"></form:errors>
																	</div><!-- .has-error -->
									   							</div><!-- .form-group -->
			                                    			</div><!-- col-md-4 -->
			                                    			<!-- **************************************************Datos  Documento Familiar**************************************************************** -->
		                                    				<div class="col-md-4">
																<div class="form-group">
																	<form:label path="familiar.documento_iddocumento.documento">${documentoEtiqueta}</form:label>
																	<div class="input-group">
																		<form:input type="number" min="${numMin}" cssClass="form-control" path="familiar.documento_iddocumento.documento" id="familiarDocumento" name="familiarDocumento" placeholder="${documentoMarcador}" required="required"></form:input>
																	</div><!-- .input-group -->
																</div><!-- .form-group -->
															</div><!-- .col-md-4 -->
															...
															<div class="col-md-4">
																<div class="form-group">
																	<form:label path="familiar.nombres">${nombresEtiqueta}</form:label>
																	<div class="input-group">    
																		<form:input type="text" cssClass="form-control" path="familiar.nombres" id="familiarNombres" name="familiarNombres" placeholder="${nombresMarcador}" required="required"></form:input>
																	</div><!-- .input-group -->
																</div><!-- .form-group -->
															</div><!-- .col-md-4 -->
															<div class="col-md-4">
																<div class="form-group">
																	<form:label path="familiar.primerApellido">${primerApellidoEtiqueta}</form:label>
																	<div class="input-group">    
																		<form:input type="text" cssClass="form-control" path="familiar.primerApellido" id="familiarPrimerApellido" name="familiarPrimerApellido" placeholder="${primerApellidoMarcador}" required="required"></form:input>
																	</div><!-- .input-group -->
																</div><!-- .form-group -->
															</div><!-- .col-md-4 -->
															<div class="col-md-4">
																<div class="form-group">
																	<form:label path="familiar.segundoApellido">${segundoApellidoEtiqueta}</form:label>
																	<div class="input-group">    
																		<form:input type="text" cssClass="form-control" path="familiar.segundoApellido" id="familiarSegundoApellido" name="familiarSegundoApellido" placeholder="${segundoApellidoMarcador}"></form:input>
																	</div><!-- .input-group -->
																</div><!-- .form-group -->
															</div><!-- .col-md-4 -->
															<!-- ***********************************************Edad Familiar************************************************************************** -->
															<div class="col-md-4">
																<div class="form-group">
																	<form:label path="familiar.edad">${edadEtiqueta}</form:label>
																	<div class="input-group">  
																		<form:input type="number" min="${numMin}" cssClass="form-control" path="familiar.edad" id="familiarEdad" name="familiarEdad" placeholder="${edadMarcador}" requiered="required"></form:input>
																	</div><!-- .input-group -->
																</div><!-- .form-group -->
															</div><!-- .col-md-4 -->
															<!-- **************************************************Ocupacion Familiar**************************************************************** -->
									   						<div class="col-md-4">
																<div class="form-group">
																	<form:label path="familiar.ocupacion">${ocupacionEtiqueta}</form:label>
																	<div class="input-group">  
																		<form:input type="text" cssClass="form-control" path="familiar.ocupacion" id="familiarOcupacion" name="familiarOcupacion" placeholder="${ocupacionMarcador}"></form:input>
																	</div><!-- .input-group -->
																</div><!-- .form-group -->
															</div><!-- .col-md-4 -->
															<div class="col-md-4">
																<input id="btnAgregar" type="submit" class="btn btn-blue" value="${botonGuardarEtiqueta}" style="float:center;">
															</div><!-- .col-md-4 -->
															<div class="col-md-4">
																<c:if test="${!empty familiares}">
																	<div class="table-responsive">
																		<table id="familiares" class="table table-hover">
																			<thead>
																				<tr>
																					<th>${parentescoEtiqueta}</th>
																					<th>${documentoEtiqueta}</th>
																					<th>${nombresEtiqueta}</th>
																					<th>${primerApellidoEtiqueta}</th>
																					<th>${segundoApellidoEtiqueta}</th>
																					<th>${edadEtiqueta}</th>
																					<th>${ocupacionEtiqueta}</th>
																				</tr>
																			</thead>
																			<tbody>
																				 <c:forEach items="${familiares}" var="familiar">
																				 	<tr>
																				 		<th>${familiar.parentesco_idparentesco.parentesco}</th>
																				 		<th>${familiar.documento_iddocumento.documento}</th>
																						<th>${familiar.nombres}</th>
																						<th>${familiar.primerApellido}</th>
																						<th>${familiar.edad}</th>
																						<th>${familiar.ocupacion}</th>
																				 	</tr>
																				 </c:forEach>
																			</tbody>
