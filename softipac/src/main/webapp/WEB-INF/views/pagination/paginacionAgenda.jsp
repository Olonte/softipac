<div class="custom-pagination">
	<ul class="pagination pull-right">
		<c:url var="primeraUrl" value="/paginaAgenda/${paginaInicial}"></c:url>
		<c:url var="ultimaUrl" value="/paginaAgenda/${citas.size()}"></c:url>
		<c:url var="anteriorUrl" value="/paginaAgenda/${indiceActual - 1}"></c:url>
		<c:url var="siguienteUrl" value="/paginaAgenda/${indiceActual + 1}"></c:url>
		<c:choose>
