...
<html lang="en">
	...
	<head>
        ...
        <link href="<c:url value="/static/css/datepicker/bootstrap-datetimepicker.min.css"></c:url>" rel="stylesheet">  
	    <link href="<c:url value="/static/css/bootstrap-datepicker.min.css.map"></c:url>"rel="stylesheet"> 
	    <link href="<c:url value="/static/css/timepicker/jquery.timepicker.css"></c:url>"rel="stylesheet"> 
